...
| 0x01 | NOT R0 | R0 ← 0xFF55 |
| 0x02 | NOT R0 | R0 ← 0x00AA (원복) |
| 0x03 | ADD R0,[0x82] | R0 ← 0x0000 |
...
| 0x21 | AND R0,[0x80] | R0 ← 0x0000 |
| 0x22 | BRZ R0 | skip (R0=0) |
| 0x23 | WFR | (도달하면 안 됨) |
| 0x24 | ADD R0,[0x81] | R0 ← 0x0001 |
| 0x25 | ADD R0,[0x83] | R0 ← 0x0000 |
...
| 0x42 | NOT R1 | R1 ← 0xFFFC |
| 0x43 | ADD R1,[0x81] | R1 ← 0xFFFD (-3) |
| 0x44 | ADD R0,R1 (m=1) | R0 ← 0x0002 |
| 0x45 | ADD R0,[0x86] | R0 ← 0x0000 |
