...
|------|------|------|---|
| 0x80 | 0x0000 | 상수 0 |
| 0x82 | 0xAAAA | 임시 변수 초기값 | 다음의 값으로 업데이트 됨 <br> 0x00FF <br> 0x0000 |
...
| 주소 | 명령어 | 동작 |설명|
|------|--------|------|--|
| 0x40 | STA [0x82],R0 | mem[0x82] ← R0 |0x00FF 값 [0x82]에 저장|
| 0x41 | LDA R0,[0x80] | R0 ← 0x0000 |[0x80]|
| 0x42 | STA [0x82],R0 | mem[0x82] ← R0 |0x0000 덮어쓰기|
...
- `test_ctrl.dat`를 열고 **Comment #1** 영역에 바이너리를 작성한다.
